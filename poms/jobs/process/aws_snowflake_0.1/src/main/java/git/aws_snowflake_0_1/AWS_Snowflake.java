		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.Config_file,
...
/************************************************************************************************
 * 82209 characters generated by Talend Open Studio for Data Integration on the
 * October 27, 2022 at 11:45:42 AM CEST
 ************************************************************************************************/